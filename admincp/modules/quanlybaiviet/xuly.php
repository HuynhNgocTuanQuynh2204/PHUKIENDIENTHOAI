...
session_start();
   ...
   //them
    $sql_them = "INSERT INTO tbl_baiviet(tenbaiviet,hinhanh,tomtat,noidung,tinhtrang,id_admin) VALUE('".$tenbaiviet."
      ','".$hinhanh_time."','".$tomtat."','".$noidung."','".$tinhtrang."','".$id_admin."')";
   ...
   elseif (isset($_POST['suabaiviet'])){
      ...
      if($hinhanh !=''){
         ...
         ."', id_admin ='".$id_admin."' WHERE id_baiviet='$_GET[idbaiviet]'";
