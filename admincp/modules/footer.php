    ...
    <div class="container p-4">
      ...
      <div class="row my-4">
        ...
        <div class="rounded-circle bg-white shadow-1-strong d-flex align-items-center justify-content-center mb-4 mx-auto" style="width: 150px; height: 150px; overflow: hidden;">
            <img src="https://png.pngtree.com/png-clipart/20200727/original/pngtree-smartphone-shop-sale-logo-design-png-image_5069958.jpg" height="70" alt="" loading="lazy" style="object-fit: cover; width: 100%; height: 100%; border-radius: 50%;">
        </div>
