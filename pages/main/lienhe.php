<h3 style="text-align: center;text-transform: uppercase;font-weight: bold;">Phụ kiện điện thoại - Biến điện thoại của bạn thành một tác phẩm nghệ thuật!</h3>
<?php
    ...
    <div class="row">
      <div class="col-lg-12 ">
        <div class="text-center mb-4">
          ...
          Chúng tôi luôn hoan nghênh mọi phản hồi từ bạn. Hãy gửi cho chúng tôi ý kiến, đề xuất hoặc bất kỳ ý tưởng nào để chúng tôi có thể cải thiện dịch vụ của mình.

Hãy điền vào biểu mẫu dưới đây và gửi cho chúng tôi:

Giờ làm việc:

Thứ Hai - Thứ Sáu: 8:00 sáng đến 8:00 tối
Thứ Bảy: 9:00 sáng đến 5:00 chiều
Chủ Nhật: Nghỉ
