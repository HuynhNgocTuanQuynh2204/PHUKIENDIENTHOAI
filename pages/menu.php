<div class="header_down d-flex justify-content-center bg-header">
                    <nav style="padding: 0" class="navbar navbar-expand">
                          ...
                          <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav">
                              ...
                              <li class="nav-item dropdown-hover">
                                <a class="nav-link link d-flex align-items-center" href="#"><span>Danh sách sản phẩm</span> <span style="line-height: 0;" class="material-symbols-outlined">
                                    arrow_drop_down
                                </span></a>
                                <?php
                       ...
                       ?>
                              ...
                              <li class="nav-item">
                                <a class="nav-link link" href="index.php?quanly=tintuc">Tin tức hiện nay</a>
                              </li>
                              <li class="nav-item">
